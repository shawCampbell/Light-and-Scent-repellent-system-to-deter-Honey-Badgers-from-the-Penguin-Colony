...
class ESPEmulator:
    def __init__(self, server_ip, server_port, esp_id="ESP32-CAM-001"):
        ...
        self.ip_address = "196.47.241.166"
        self.port_number = port
        
        self.peers = []  # To store peer information
        self.running = True
        self.tcp_port = 1236#1235
        self.last_detection_time = 0
        self.detection_interval = 30000000  # seconds
        self.ping_interval = 5  # seconds
        self.last_ping_time = 0
        
        # Create a test image if it doesn't exist
        self.test_image_path = "test.jpg"#f"test_image_{esp_id}.jpg"
...
'''
    ...
    def send_detection_to_peer(self, peer, header, image_data):
        ...
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as tcp_sock:
                ...
                tcp_sock.connect((peer['ipAddress'], 1235))#peer['portNumber']))
            ...
            print(f"{self.esp_id}: Failed to forward to peer {peer['userID']} - {str(e)}")
            return False
    ...
    def send_detection_alert(self):
        ...
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as tcp_sock:
                ...
                if False:#random.random() > 0.7:  # 30% chance of failure
    ...
    def listen_for_peers(self):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            s.bind(('0.0.0.0', 1237))#self.port_number))
            s.listen(5)
            s.settimeout(1.0)
